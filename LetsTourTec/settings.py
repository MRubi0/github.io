...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@letstourtec.app')

# --- URL del frontend (para los enlaces en emails) ---
FRONTEND_URL = config('FRONTEND_URL', default='https://letstourtec.app')
